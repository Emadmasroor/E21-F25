...
**What to turn in:** Code for (1.1) and (1.3), PDF for (1.2) and (1.3)
...
- A tolerance parameter that terminates the search when $||x_{n+1}-x_n||$ is lower than a certain threshold.
